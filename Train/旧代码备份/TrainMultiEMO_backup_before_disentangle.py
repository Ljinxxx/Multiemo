...
class TrainMultiEMO():
    ...
    def train_or_eval_linear_model(self):
        for e in range(self.num_epochs):
            ...
            print(
                'Epoch {}, train loss: {}, train HGR loss: {}, train SWFC loss: {}, train CE loss: {}, train AUX loss: {}, train CMCL loss: {}, train GraphEmo loss: {}, train ID loss: {}, train ORTHO loss: {}, train f1: {}, train acc: {}'.format(
                    e + 1,
                    train_loss,
                    train_HGR_loss,
                    train_SWFC_loss,
            ...
            print(
                'Epoch {}, valid loss: {}, valid HGR loss: {}, valid SWFC loss: {}, valid CE loss: {}, valid AUX loss: {}, valid CMCL loss: {}, valid GraphEmo loss: {}, valid ID loss: {}, valid ORTHO loss: {}, valid f1: {}, valid acc: {}'.format(
                    e + 1,
                    valid_loss,
                    valid_HGR_loss,
                    valid_SWFC_loss,
            ...
            print(
                'Epoch {}, test loss: {}, test HGR loss: {}, test SWFC loss: {}, test CE loss: {}, test AUX loss: {}, test CMCL loss: {}, test GraphEmo loss: {}, test ID loss: {}, test ORTHO loss: {}, test f1: {}, test acc: {}, '.format(
                    e + 1,
                    test_loss,
                    test_HGR_loss,
                    test_SWFC_loss,
